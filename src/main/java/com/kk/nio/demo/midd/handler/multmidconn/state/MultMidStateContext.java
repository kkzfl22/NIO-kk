 ...
 * @author liujun
 */
public class MultMidStateContext {
	 ...
	 * 后端的连接信息
	 */
	private BaseHandler mysqlConn;

	/**
	 * 当前的状态信息
	 */
	private MultMidStateInf currState;

	public MultMidStateContext(SocketChannel channel) {
		super();
	...
	public MultMidStateInf getCurrState() {
		return currState;
	}

	public void setCurrState(MultMidStateInf currState) {
