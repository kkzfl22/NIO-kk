 ...
 * @author liujun
 */
public class MysqlMidMultNioAcceptor implements Runnable {
	 ...
	 * 多路选择器
	 */
	private MysqlMultReactor[] reactor;
	...
	public MysqlMidMultNioAcceptor(int port, MysqlMultReactor[] reactor) throws IOException {
