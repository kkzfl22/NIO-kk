 ...
 * @author liujun
 */
public class LoginMysqlServiceHandler extends MysqlServerHandlerBase implements MsgDataServiceInf {
	...
	public void readData(MysqlContext context) throws IOException {
		...
		HandshakeBean msg = (HandshakeBean) this.msgEndecode.msgDecode(context);
