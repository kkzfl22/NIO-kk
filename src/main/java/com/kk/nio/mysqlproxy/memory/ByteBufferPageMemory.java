 ...
 * 进行内存页的管理
 * 
 * @since 2017年6月23日 下午4:19:38
 * @version 0.0.1
 * @author liujun
 */
@SuppressWarnings("restriction")
public class ByteBufferPageMemory {
	...
	public ByteBufferPageMemory(ByteBuffer buffer, int chunkSize) {
		this.buffer = buffer;
	...
	public static void main(String[] args) {
		...
		ByteBufferPageMemory page = new ByteBufferPageMemory(buffer, 256);
