 ...
 * @author liujun
 */
public class MysqlClientMultReactor extends Thread {
	...
	public MysqlClientMultReactor(ExecutorService executor) throws IOException {
	...
	public void rigisterNewConn(SocketChannel socket) throws IOException {
		...
		new MysqClientMidIOHandler(select, socket);
	}
