...
public enum MysqlServerStatusEnum {
	...
	private MysqlServerStatusEnum(int statusBit) {
	 ...
	 */
	public static boolean StatusCheck(int value, MysqlServerStatusEnum status) {
	...
	public static void main(String[] args) {
		boolean result = MysqlServerStatusEnum.StatusCheck(0x0002, MysqlServerStatusEnum.MORE_RESULTS);
